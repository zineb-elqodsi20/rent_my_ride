      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <Link href="/" className="flex items-center">
            <img src="/images/logo.png" alt="Rent My Ride Logo" className="h-10 object-contain" />
          </Link>

          {/* Menu */}
          <div className="hidden md:flex items-center space-x-8">
            {['home', "aboutMenu", 'List.cars', 'contact'].map((routeName) => (
               <Link
               key={routeName}
               href={
                 routeName === 'List.cars'
          ...
          {/* Sélecteur de langue + Login/Register - Style unifié */}
          <div className="flex items-center space-x-4">
            {/* Select langue style premium */}
