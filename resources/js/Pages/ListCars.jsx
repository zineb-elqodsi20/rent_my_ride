...
const ListCars = ({ cars, handleReserve }) => {
  ...
  return (
    ...
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-10 tracking-tight drop-shadow-md">
          {t('available_cars')}
        </h1>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-4 border-t border-gray-100 pt-4">
                  <div>
                    <span className="text-gray-500 text-sm">{t('starting_from')}</span>
                    <p className="text-2xl font-bold text-indigo-700">{car.prix_par_jour} MAD</p>
                    <span className="text-gray-500 text-xs">/ {t('per_day')}</span>
                  </div>
